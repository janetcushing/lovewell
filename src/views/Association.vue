  ...
  <div class="home">
    ...
    <div class="container blurb-container">
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="row">
            <h2 class="l-heading">Association Officers</h2>
          </div>
          <div class="row">
            <table>
              <col width="175" />
              <tr v-for="person in officers" :key="person.id">
                <td class="l-small-sub-heading">
                  {{ person.title }}
                </td>
                <td class="l-small-text">{{ person.name }}</td>
              </tr>
            </table>
          </div>
          <br />
          ...
          <div class="row">
            <h6>
              <strong
                ...
                for his many years of serving as LPA Treasurer !
              </strong>
            </h6>
            <p></p>
          </div>
